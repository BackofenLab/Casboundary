...
if __name__ == '__main__':
    ...
    parser.add_argument('-g', '--maximum-gap', nargs='?', dest='max_gap', help='Maximum number of contiguous gaps allowed in a cassette. Available options: 0 <= gap <= 3 (default: 1).', type=int, choices=range(3), default=1)
